...
class FragmentIntroPaciente : Fragment() {
    private var _binding: FragmentIntroPacienteBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentIntroPacienteBinding.inflate(inflater, container, false)
        return binding.root
    }
